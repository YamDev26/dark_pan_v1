...
<table class="bulletin_footer">
  ...
  <tr style="width: 100%">
    ...
    <th style="width: 35%">Appréciation du conseil de classe</th>
    <th style="width: 35%">Visa du chef d'établissement</th>
  </tr>

  <tr>
    <td style="vertical-align: middle; text-align:center; padding:0%">
      Moy. 1e Trim : <strong>12.30</strong> ~ R: <strong>8eme</strong>/15
    </td>
    <!-- APPRECIATION -->
    <td class="center">
      <div class="appreciation">
        <strong>Bon travail. Des efforts supplémentaires vous permettront d'aller encore plus loin.</strong>
        <br>
