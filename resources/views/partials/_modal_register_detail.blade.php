<div class="modal" id="DtailModal" tabindex="-1" aria-labelledby="DtailModalLabel" aria-hidden="true" style="font-size: 14px">
    ...
    <div class="modal-content" style="background: #191C24">
      ...
      <div class="modal-body pb-0 mb-0">
        ...
        <div>
          ...
          <div class="form-check form-check-inline mt-3 mb-0" style="font-size: 13px; float: right">
            <input type="checkbox" name="deletes" class="form-check-input" id="deletes">
            <label class="form-check-label" for="deletes">Coché pour annuler cette inscription !</label>
          </div>
        </div>
      </div>
      <form action="#" method="get" id="myDetail" target="_blank">
        ...
        <div class="modal-footer my-0">
          <button type="button" class="btn btn-outline-primary py-1" id="dltsBtn" style="font-size: 14px; display: none">Delete</button>
          <div id="principalBtn">
