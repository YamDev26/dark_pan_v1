            ...
            <div class="row px-sm-3">
              ...
              <div class="col-4 mb-2">
                ...
                <div class="form-check form-check-inline ml-2">
                  <input type="radio" name="civility" class="form-check-input disabled" id="feminin" value="mme" {{ $data ? ($data->civility == 'mme' ? 'checked':''): (old('civility') == 'mme' ? 'checked':'') }} disabled>
                  <label class="form-check-label" for="feminin">Madame</label>
                </div>
                <div class="form-check form-check-inline">
                  <input type="radio" name="civility" class="form-check-input disabled" id="masculin" value="mr" {{ $data ? ($data->civility == 'mr' ? 'checked':''): (old('civility') == 'mr' ? 'checked':'checked') }} disabled>
              ...
              <div class="col-12 col-sm-6 mb-2">
                ...
                <input type="text" name="first" class="form-control disabled" id="first" value="{{ old('first', $data ? $data->first_name:null) }}" placeholder="Nom Enseignant" disabled>
              </div>
              <div class="col-12 col-sm-6 mb-2">
              ...
              <div class="col-12 col-sm-6 mb-2">
                ...
                <input type="date" name="date" class="form-control disabled" id="date" value="{{ old('date', $data ? $data->teacher->date_naiss:null) }}">
              </div>
              <div class="col-12 col-sm-6 mb-2">
