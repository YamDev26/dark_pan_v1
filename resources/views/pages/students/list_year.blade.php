@extends('app')
@section('title', 'List Student '.$year['libelle'])
@section('link')
...
<div class="container-fluid pt-4 px-4">
  <div class="bg-secondary text-center rounded p-4">
    <div class="d-flex align-items-center justify-content-between mb-4 pb-2" style="border-bottom: 3px solid #6C7293">
      <h4 class="mb-0">Elèves {{ $year['libelle'] }}</h4>
      <a href="{{ route('student.index') }}" class="btn btn-outline-light py-1 mx-2">Return</a>
    </div>
...
<script>
  $(document).ready(function() {
    $('#myTable').DataTable({
      ...
      serverSide: true,
      ordering: false,
      ajax: '{{ route('student.search', $year["id"]) }}',
      columns: [
        ...
        {data: 'residence', className: 'text-left'},
