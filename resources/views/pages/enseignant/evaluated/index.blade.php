      ...
      <table class="table table-bordered table-hover align-middle" id="myTable">
        <thead>
          <tr class="text-white">
            ...
            <th scope="col" class="w-25">Matière</th>
...
<script>
  $(document).ready(function() {
    ...
    $('#myTable').DataTable({
      ...
      serverSide: true,
      ordering: false,
      ajax: '{{ route('evaluation.dataTable') }}',
      columns: [
        ...
        {data: 'matters', className: 'text-center'},
