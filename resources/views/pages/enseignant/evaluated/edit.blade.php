        ...
        <table class="table table-bordered table-hover align-middle" id="myTable">
          <thead>
            <tr class="text-white">
              ...
              <th scope="col" class="text-center" style="width: 15%">Notes</th>
            </tr>
          </thead>
          <tbody>
            @foreach ($datas as $i => $item)
              <tr>
                ...
                <td class="d-flex py-0 text-center">
                  ...
                  <input type="text" name="note[]" class="form-control mx-0 input" data-not="{{ $item->value * 20 }}" value="{{ $item->note }}" placeholder="---" style="width: 90px; background: none; font-size: 19px">
